...
static void R_LoadBspLightgrid(r_model_t *mod) {
	...
	out->lights0 = (r_image_t *) R_AllocMedia("lightgrid_lights0", sizeof(r_image_t), R_MEDIA_IMAGE);
	out->lights0->media.Free = R_FreeImage;
	out->lights0->type = IMG_LIGHTGRID;
	out->lights0->width = out->size.x;
	out->lights0->height = out->size.y;
	out->lights0->depth = out->size.z;
	out->lights0->target = GL_TEXTURE_3D;
	out->lights0->levels = 0;
	out->lights0->minify = GL_NEAREST;
	out->lights0->magnify = GL_NEAREST;
	out->lights0->internal_format = GL_RG16I;
	out->lights0->format = GL_RG_INTEGER;
	out->lights0->pixel_type = GL_UNSIGNED_SHORT;
	
	glActiveTexture(GL_TEXTURE0 + TEXTURE_LIGHTGRID_LIGHTS0);
	
	R_UploadImage(out->lights0, data);
	data += luxels * sizeof(color_rg16_t);
	
	out->lights1 = (r_image_t *) R_AllocMedia("lightgrid_lights1", sizeof(r_image_t), R_MEDIA_IMAGE);
	out->lights1->media.Free = R_FreeImage;
	out->lights1->type = IMG_LIGHTGRID;
	out->lights1->width = out->size.x;
	out->lights1->height = out->size.y;
	out->lights1->depth = out->size.z;
	out->lights1->target = GL_TEXTURE_3D;
	out->lights1->levels = 0;
	out->lights1->minify = GL_NEAREST;
	out->lights1->magnify = GL_NEAREST;
	out->lights1->internal_format = GL_RG16I;
	out->lights1->format = GL_RG_INTEGER;
	out->lights1->pixel_type = GL_UNSIGNED_SHORT;

	glActiveTexture(GL_TEXTURE0 + TEXTURE_LIGHTGRID_LIGHTS1);
	
	R_UploadImage(out->lights1, data);
	data += luxels * sizeof(color_rg16_t);
	
	out->lights2 = (r_image_t *) R_AllocMedia("lightgrid_lights2", sizeof(r_image_t), R_MEDIA_IMAGE);
	out->lights2->media.Free = R_FreeImage;
	out->lights2->type = IMG_LIGHTGRID;
	out->lights2->width = out->size.x;
	out->lights2->height = out->size.y;
	out->lights2->depth = out->size.z;
	out->lights2->target = GL_TEXTURE_3D;
	out->lights2->levels = 0;
	out->lights2->minify = GL_NEAREST;
	out->lights2->magnify = GL_NEAREST;
	out->lights2->internal_format = GL_RG16I;
	out->lights2->format = GL_RG_INTEGER;
	out->lights2->pixel_type = GL_UNSIGNED_SHORT;

	glActiveTexture(GL_TEXTURE0 + TEXTURE_LIGHTGRID_LIGHTS2);
	
	R_UploadImage(out->lights2, data);
	data += luxels * sizeof(color_rg16_t);
	
	out->lights3 = (r_image_t *) R_AllocMedia("lightgrid_lights3", sizeof(r_image_t), R_MEDIA_IMAGE);
	out->lights3->media.Free = R_FreeImage;
	out->lights3->type = IMG_LIGHTGRID;
	out->lights3->width = out->size.x;
	out->lights3->height = out->size.y;
	out->lights3->depth = out->size.z;
	out->lights3->target = GL_TEXTURE_3D;
	out->lights3->levels = 0;
	out->lights3->minify = GL_NEAREST;
	out->lights3->magnify = GL_NEAREST;
	out->lights3->internal_format = GL_RG16I;
	out->lights3->format = GL_RG_INTEGER;
	out->lights3->pixel_type = GL_UNSIGNED_SHORT;

	glActiveTexture(GL_TEXTURE0 + TEXTURE_LIGHTGRID_LIGHTS3);
	
	R_UploadImage(out->lights3, data);
	data += luxels * sizeof(color_rg16_t);
	
	out->lights4 = (r_image_t *) R_AllocMedia("lightgrid_lights4", sizeof(r_image_t), R_MEDIA_IMAGE);
	out->lights4->media.Free = R_FreeImage;
	out->lights4->type = IMG_LIGHTGRID;
	out->lights4->width = out->size.x;
	out->lights4->height = out->size.y;
	out->lights4->depth = out->size.z;
	out->lights4->target = GL_TEXTURE_3D;
	out->lights4->levels = 0;
	out->lights4->minify = GL_NEAREST;
	out->lights4->magnify = GL_NEAREST;
	out->lights4->internal_format = GL_RG16I;
	out->lights4->format = GL_RG_INTEGER;
	out->lights4->pixel_type = GL_UNSIGNED_SHORT;

	glActiveTexture(GL_TEXTURE0 + TEXTURE_LIGHTGRID_LIGHTS3);
	
	R_UploadImage(out->lights4, data);
	data += luxels * sizeof(color_rg16_t);
	
	out->lights5 = (r_image_t *) R_AllocMedia("lightgrid_lights5", sizeof(r_image_t), R_MEDIA_IMAGE);
	out->lights5->media.Free = R_FreeImage;
	out->lights5->type = IMG_LIGHTGRID;
	out->lights5->width = out->size.x;
	out->lights5->height = out->size.y;
	out->lights5->depth = out->size.z;
	out->lights5->target = GL_TEXTURE_3D;
	out->lights5->levels = 0;
	out->lights5->minify = GL_NEAREST;
	out->lights5->magnify = GL_NEAREST;
	out->lights5->internal_format = GL_RG16I;
	out->lights5->format = GL_RG_INTEGER;
	out->lights5->pixel_type = GL_UNSIGNED_SHORT;

	glActiveTexture(GL_TEXTURE0 + TEXTURE_LIGHTGRID_LIGHTS3);
	
	R_UploadImage(out->lights5, data);
	data += luxels * sizeof(color_rg16_t);
