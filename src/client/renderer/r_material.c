...
static r_material_t *R_ResolveMaterial(cm_material_t *cm, cm_asset_context_t context) {
	...
	if (r_texture_quality->integer > 1) {
		SDL_Surface *scaled = SDL_CreateRGBSurfaceWithFormat(0, diffusemap->w / r_texture_quality->integer, diffusemap->h / r_texture_quality->integer, 32, SDL_PIXELFORMAT_RGBA32);
