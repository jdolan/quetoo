...
void R_CreateBuffer(r_buffer_t *buffer, const GLenum element_type, const GLubyte element_count, const GLboolean element_normalized,
...
#define R_CreateElementBuffer(buffer, element_type, hint, size, data) R_CreateBuffer(buffer, element_type, 1, GL_FALSE, hint, R_BUFFER_ELEMENT, size, data)
