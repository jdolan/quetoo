...
set CYGWIN=nontsec
set /p ARCHITECTURE= <arch.cfg
rsync.exe -rzhP --delete --exclude=rsync.exe --exclude=cygwin1.dll --exclude=Update.bat --exclude=Update.exe --exclude=default rsync://jdolan.dyndns.org/quake2world-win32/%ARCHITECTURE%/ .
