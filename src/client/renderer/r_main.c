...
#if BUILD_RTX
  r_rtx = Cvar_Add("r_rtx", "0", CVAR_ARCHIVE, "Enable the native Vulkan RTX backend while keeping the game playable.");
  r_rtx_overlay = Cvar_Add("r_rtx_overlay", "1", CVAR_ARCHIVE, "Draw a small RTX/VK status tile when r_rtx is enabled.");
