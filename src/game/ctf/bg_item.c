...
const GameItemDef bgItemDefs[] = {
...

  {
    ...
    .pickupSound = "weapons/common/pickup.wav",
    ...
    .tag = WEAPON_BLASTER,
    .effectColor = { { 0.731f, 0.379f, 0.025f, 1.f } },
    .flags = WF_PROJECTILE,
    .priority = 0.10,
...

  {
    ...
    .effects = EF_ROTATE | EF_BOB,
    .icon = "pics/machinegun",
    .name = "Machinegun",
    .quantity = 1,
    .ammo = AMMO_BULLETS,
    .type = ITEM_TYPE_WEAPON,
    .tag = WEAPON_MACHINEGUN,
    .effectColor = { { 0.739f, 0.556f, 0.032f, 1.f } },
    .flags = WF_HITSCAN | WF_SHORT_RANGE | WF_MED_RANGE,
    .priority = 0.30,
...

  {
    ...
    .effects = EF_ROTATE | EF_BOB,
    .icon = "pics/handgrenade",
    .name = "Hand Grenades",
    .quantity = 1,
    .ammo = AMMO_GRENADES,
    .type = ITEM_TYPE_WEAPON,
    .tag = WEAPON_HAND_GRENADE,
    .effectColor = { { 0.050f, 0.821f, 0.033f, 1.f } },
...

  {
    ...
    .effects = EF_ROTATE | EF_BOB,
    .icon = "pics/rocketlauncher",
    .name = "Rocket Launcher",
    .quantity = 1,
    .ammo = AMMO_ROCKETS,
    .type = ITEM_TYPE_WEAPON,
    .tag = WEAPON_ROCKET_LAUNCHER,
    .effectColor = { { 0.666f, 0.027f, 0.030f, 1.f } },
...

  {
    ...
    .effects = EF_ROTATE | EF_BOB,
    .icon = "pics/hyperblaster",
    .name = "Hyperblaster",
    .quantity = 1,
    .ammo = AMMO_CELLS,
    .type = ITEM_TYPE_WEAPON,
    .tag = WEAPON_HYPERBLASTER,
    .effectColor = { { 0.046f, 0.669f, 0.683f, 1.f } },
...

  {
    ...
    .effectColor = { { 0.624f, 0.663f, 0.751f, 1.f } },
    .flags = WF_HITSCAN | WF_SHORT_RANGE,
    .priority = 0.50,
...

  {
    ...
    .type = ITEM_TYPE_WEAPON,
    .tag = WEAPON_RAILGUN,
    .effectColor = { { 0.040f, 0.082f, 0.587f, 1.f } },
...

  {
    ...
    .type = ITEM_TYPE_WEAPON,
    .tag = WEAPON_BFG10K,
    .effectColor = { { 0.468f, 0.772f, 0.005f, 1.f } },
...

  {
    ...
    .effects = EF_ROTATE,
    .icon = "pics/quake_shotgun",
    .name = "Shotgun",
    .quantity = 1,
    .ammo = AMMO_QUAKE_SHELLS,
    .type = ITEM_TYPE_WEAPON,
    .tag = WEAPON_QUAKE_SHOTGUN,
    .effectColor = { { 0.402f, 0.333f, 0.137f, 1.f } },
    .flags = WF_HITSCAN | WF_SHORT_RANGE,
    .priority = 0.15,
    .precaches = "weapons/shotgun/fire.wav"
  },
...

  {
    ...
    .effects = EF_ROTATE,
    .icon = "pics/quake_nailgun",
    .name = "Nailgun",
    .quantity = 1,
    .ammo = AMMO_QUAKE_NAILS,
    .type = ITEM_TYPE_WEAPON,
    .tag = WEAPON_QUAKE_NAILGUN,
    .effectColor = { { 0.652f, 0.664f, 0.604f, 1.f } },
...

  {
    ...
    .effects = EF_ROTATE,
    .icon = "pics/quake_grenadelauncher",
    .name = "Grenade Launcher",
    .quantity = 1,
    .ammo = AMMO_QUAKE_ROCKETS,
    .type = ITEM_TYPE_WEAPON,
    .tag = WEAPON_QUAKE_GRENADE_LAUNCHER,
    .effectColor = { { 0.600f, 0.200f, 0.050f, 1.f } },
...

  {
    ...
    .effects = EF_ROTATE,
    .icon = "pics/quake_rocketlauncher",
    .name = "Rocket Launcher",
    .quantity = 1,
    .ammo = AMMO_QUAKE_ROCKETS,
    .type = ITEM_TYPE_WEAPON,
...

  {
    ...
    .effects = EF_ROTATE,
    .icon = "pics/quake_thunderbolt",
    .name = "Thunderbolt",
    .quantity = 1,
    .ammo = AMMO_QUAKE_BOLTS,
    .type = ITEM_TYPE_WEAPON,
    .tag = WEAPON_QUAKE_THUNDERBOLT,
    .effectColor = { { 0.434f, 0.341f, 0.065f, 1.f } },
    .flags = WF_HITSCAN | WF_SHORT_RANGE,
    .priority = 0.55,
    .precaches = "weapons/lightning/fire.wav weapons/lightning/fly.wav "
    "weapons/lightning/discharge.wav"
...

  {
    ...
    .pickupSound = "ammo/common/pickup.wav",
...

  {
    ...
    .pickupSound = "armor/shard/pickup.wav",
    .model = "models/armor/shard/tris.md3",
    .effects = EF_ROTATE | EF_BOB,
    .icon = "pics/armor_shard",
    .name = "Armor Shard",
    .quantity = 2,
    .type = ITEM_TYPE_ARMOR,
    .tag = ARMOR_SHARD,
    .effectColor = { { 0.3f, 0.8f, 0.2f, 1.f } },
    .priority = 0.10,
    .precaches = ""
  },

  {
    ...
    .pickupSound = "armor/jacket/pickup.wav",
    .model = "models/armor/jacket/tris.md3",
    .effects = EF_ROTATE | EF_BOB,
    .icon = "pics/armor_jacket",
    .name = "Jacket Armor",
    .quantity = 25,
    .max = 50,
    .type = ITEM_TYPE_ARMOR,
    .tag = ARMOR_JACKET,
    .effectColor = { { 0.122f, 0.628f, 0.143f, 1.f } },
    .priority = 0.50,
    .precaches = ""
  },

  {
    ...
    .pickupSound = "armor/combat/pickup.wav",
    .model = "models/armor/combat/tris.md3",
    .effects = EF_ROTATE | EF_BOB,
    .icon = "pics/armor_combat",
    .name = "Combat Armor",
    .quantity = 50,
    .max = 100,
    .type = ITEM_TYPE_ARMOR,
    .tag = ARMOR_COMBAT,
    .effectColor = { { 0.511f, 0.423f, 0.105f, 1.f } },
    .priority = 0.66,
    .precaches = ""
  },

  {
    ...
    .pickupSound = "armor/body/pickup.wav",
    .model = "models/armor/body/tris.md3",
    .effects = EF_ROTATE | EF_BOB,
    .icon = "pics/armor_body",
    .name = "Body Armor",
    .quantity = 100,
    .max = 200,
    .type = ITEM_TYPE_ARMOR,
    .tag = ARMOR_BODY,
    .effectColor = { { 0.436f, 0.145f, 0.130f, 1.f } },
    .priority = 0.80,
    .precaches = ""
  },

  {
    ...
    .effects = EF_ROTATE,
    .icon = "pics/quake_armor_jacket",
    .name = "Green Armor",
    .quantity = 100,
    .max = 100,
    .type = ITEM_TYPE_ARMOR,
    .tag = ARMOR_QUAKE_JACKET,
    .effectColor = { { 0.254f, 0.475f, 0.342f, 1.f } },
    .priority = 0.60,
    .precaches = ""
  },

  {
    ...
    .effects = EF_ROTATE,
    .icon = "pics/quake_armor_combat",
    .name = "Yellow Armor",
    .quantity = 150,
    .max = 150,
    .type = ITEM_TYPE_ARMOR,
    .tag = ARMOR_QUAKE_COMBAT,
    .effectColor = { { 0.554f, 0.495f, 0.016f, 1.f } },
    .priority = 0.75,
    .precaches = ""
  },

  {
    ...
    .effects = EF_ROTATE,
    .icon = "pics/quake_armor_body",
    .name = "Red Armor",
    .quantity = 200,
    .max = 200,
    .type = ITEM_TYPE_ARMOR,
    .tag = ARMOR_QUAKE_BODY,
    .effectColor = { { 0.793f, 0.024f, 0.071f, 1.f } },
    .priority = 0.90,
    .precaches = ""
  },

  {
    ...
    .pickupSound = "health/small/pickup.wav",
    .model = "models/health/small/tris.obj",
    .effects = EF_ROTATE | EF_BOB,
    .icon = "pics/health_small",
    .name = "Small Health",
    .quantity = 3,
    .type = ITEM_TYPE_HEALTH,
    .tag = HEALTH_SMALL,
    .effectColor = { { 0.405f, 0.707f, 0.014f, 1.f } },
    .priority = 0.10,
    .precaches = ""
  },

  {
    ...
    .pickupSound = "health/medium/pickup.wav",
    .model = "models/health/medium/tris.obj",
    .effects = EF_ROTATE | EF_BOB,
    .icon = "pics/health_medium",
    .name = "Medium Health",
    .quantity = 15,
    .type = ITEM_TYPE_HEALTH,
    .tag = HEALTH_MEDIUM,
    .effectColor = { { 0.866f, 0.594f, 0.023f, 1.f } },
    .priority = 0.25,
    .precaches = ""
  },

  {
    ...
    .pickupSound = "health/large/pickup.wav",
    .model = "models/health/large/tris.obj",
    .effects = EF_ROTATE | EF_BOB,
    .icon = "pics/health_large",
    .name = "Large Health",
    .quantity = 25,
    .type = ITEM_TYPE_HEALTH,
    .tag = HEALTH_LARGE,
    .effectColor = { { 0.754f, 0.153f, 0.016f, 1.f } },
    .priority = 0.40,
    .precaches = ""
  },

  {
    ...
    .pickupSound = "health/mega/pickup.wav",
    .model = "models/health/mega/tris.obj",
    .effects = EF_ROTATE | EF_BOB,
    .icon = "pics/health_mega",
    .name = "Mega Health",
    .quantity = 100,
    .type = ITEM_TYPE_HEALTH,
    .tag = HEALTH_MEGA,
    .effectColor = { { 0.029f, 0.462f, 0.741f, 1.f } },
    .priority = 0.60,
    .precaches = ""
  },

  {
    ...
    .effects = 0,
    .icon = "pics/quake_health_medium",
    .name = "Medium Health",
    .quantity = 15,
    .type = ITEM_TYPE_HEALTH,
    .tag = HEALTH_QUAKE_MEDIUM,
    .effectColor = { { 0.513f, 0.288f, 0.179f, 1.f } },
    .priority = 0.25,
    .precaches = ""
  },

  {
    ...
    .effects = 0,
    .icon = "pics/quake_health_large",
    .name = "Large Health",
    .quantity = 25,
    .type = ITEM_TYPE_HEALTH,
    .tag = HEALTH_QUAKE_LARGE,
    .effectColor = { { 0.566f, 0.251f, 0.143f, 1.f } },
    .priority = 0.40,
    .precaches = ""
  },

  {
    ...
    .effects = 0,
    .icon = "pics/quake_health_mega",
    .name = "Mega Health",
    .quantity = 100,
    .type = ITEM_TYPE_HEALTH,
    .tag = HEALTH_QUAKE_MEGA,
    .effectColor = { { 0.620f, 0.167f, 0.107f, 1.f } },
    .priority = 0.60,
    .precaches = ""
  },
  ...
  {
    .classname = "item_quad",
    .pickupSound = "powerups/quad/pickup.wav",
    ...
    .tag = POWERUP_QUAD,
    .effectColor = { { 0.079f, 0.309f, 0.507f, 1.f } },
    .priority = 0.80,
    .precaches = "powerups/quad/attack.wav powerups/quad/expire.wav",
    .lightColor = { { .2f, .4f, 1.f } },
    .lightRadius = 160.f,
  },

  {
    .classname = "item_adrenaline",
    .pickupSound = "powerups/adrenaline/pickup.wav",
    .model = "models/powerups/adrenaline/tris.obj",
    .effects = EF_ROTATE | EF_BOB,
    .icon = "pics/adrenaline",
    .name = "Adrenaline",
    .quantity = 0,
    .type = ITEM_TYPE_POWERUP,
    .tag = POWERUP_ADRENALINE,
    .effectColor = { { 0.022f, 0.627f, 0.069f, 1.f } },
    .priority = 0.45,
    .precaches = ""
  },
...

  {
    ...
    .effects = EF_ROTATE | EF_LIGHT | EF_LIGHT_PULSE,
    .icon = "pics/invisibility",
    .name = "Invisibility",
    .quantity = 0,
    .type = ITEM_TYPE_POWERUP,
    .tag = POWERUP_INVISIBILITY,
    .effectColor = { { 0.844f, 0.569f, 0.210f, 1.f } },
    .priority = 0.80,
    .precaches = "powerups/invisibility/expire.wav",
    .lightColor = { { 1.f, .9f, 0.f } },
    .lightRadius = 120.f
  },

  {
    ...
    .type = ITEM_TYPE_TECH,
    .tag = TECH_HASTE,
    .effectColor = { { 0.306f, 0.233f, 0.053f, 1.f } },
    .priority = 0.80,
    .precaches = ""
  },

  {
    ...
    .type = ITEM_TYPE_TECH,
    .tag = TECH_REGEN,
    .effectColor = { { 0.151f, 0.293f, 0.090f, 1.f } },
    .priority = 0.80,
    .precaches = ""
  },

  {
    ...
    .type = ITEM_TYPE_TECH,
    .tag = TECH_RESIST,
    .effectColor = { { 0.091f, 0.137f, 0.273f, 1.f } },
    .priority = 0.80,
    .precaches = ""
  },

  {
    ...
    .type = ITEM_TYPE_TECH,
    .tag = TECH_STRENGTH,
    .effectColor = { { 0.261f, 0.044f, 0.047f, 1.f } },
    .priority = 0.80,
    .precaches = ""
  },

  {
    ...
    .type = ITEM_TYPE_TECH,
    .tag = TECH_VAMPIRE,
    .effectColor = { { 0.200f, 0.087f, 0.252f, 1.f } },
    .priority = 0.80,
    .precaches = ""
  },

  {
    ...
    .type = ITEM_TYPE_FLAG,
    .tag = FLAG_RED,
    .effectColor = { { 0.90f, 0.20f, 0.20f, 1.f } },
    .priority = 0.75,
...

  {
    ...
    .type = ITEM_TYPE_FLAG,
    .tag = FLAG_BLUE,
    .effectColor = { { 0.25f, 0.40f, 1.00f, 1.f } },
    .priority = 0.75,
    .precaches = "ctf/capture.wav ctf/steal.wav ctf/return.wav"
  },

  {
    ...
    .type = ITEM_TYPE_FLAG,
    .tag = FLAG_YELLOW,
    .effectColor = { { 1.00f, 0.90f, 0.20f, 1.f } },
    .priority = 0.75,
    .precaches = "ctf/capture.wav ctf/steal.wav ctf/return.wav"
  },

  {
    ...
    .type = ITEM_TYPE_FLAG,
    .tag = FLAG_GREEN,
    .effectColor = { { 0.20f, 0.90f, 0.30f, 1.f } },
    .priority = 0.75,
    .precaches = "ctf/capture.wav ctf/steal.wav ctf/return.wav"
  }
};
