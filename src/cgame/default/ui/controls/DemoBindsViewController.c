...
#define _Class _DemoBindsViewController
...
static void loadView(ViewController *self) {
  ...
  $(self->view, awakeWithResourceName, "ui/controls/DemoBindsViewController.json");

  self->view->stylesheet = $$(Stylesheet, stylesheetWithResourceName, "ui/controls/DemoBindsViewController.css");
 ...
 */
Class *_DemoBindsViewController(void) {
  static Class *clazz;
  static Once once;

  do_once(&once, {
    clazz = _initialize(&(const ClassDef) {
      .name = "DemoBindsViewController",
      .superclass = _ViewController(),
      .instanceSize = sizeof(DemoBindsViewController),
      .interfaceOffset = offsetof(DemoBindsViewController, interface),
      .interfaceSize = sizeof(DemoBindsViewControllerInterface),
