...
typedef struct cl_client_s {
	...
	uint32_t predicted_step_time; // when the stair was traversed
	uint32_t predicted_step_interval; // interpolation interval by stair size

	vec3_t predicted_origin; // generated by cls.cgame.PredictMovement
