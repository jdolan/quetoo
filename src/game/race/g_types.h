...
typedef struct {
   ...
   */
  uint8_t race_mode; // GameRaceMode
  uint32_t race_best;
  uint16_t race_runs;
} GameScore;
...
struct GameEntity {
   ...
   */
  GameRaceBarrier race_barrier;
  GameRaceGate race_gate;
