...
_rsync_retry.sh -vrzhP --delete --inplace --rsh='ssh' dist/quake2world/* maci@jdolan.dyndns.org:/opt/rsync/quake2world-win32/"$CURRENTARCH"
_rsync_retry.sh -vrzhP --delete --inplace --rsh='ssh' dist/quake2world/* web@satgnu.net:www/satgnu.net/files/quake2world-"$CURRENTARCH"
_rsync_retry.sh -vrzhP --delete --inplace --rsh='ssh' quake2world_rev"$rev"-"$CURRENTARCH".zip web@satgnu.net:www/satgnu.net/files
