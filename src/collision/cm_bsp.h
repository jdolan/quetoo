 ...
 */
#define BSP_LIGHTMAP_LAYERS 10

/**
 * @brief Lightmap diffuse layers (color and direction).
 */
#define BSP_LIGHTMAP_CHANNELS 4
...
typedef enum {
	...
	BSP_LIGHTMAP_DIFFUSE_2,
	BSP_LIGHTMAP_DIRECTION_2,
	BSP_LIGHTMAP_DIFFUSE_3,
	BSP_LIGHTMAP_DIRECTION_3,
