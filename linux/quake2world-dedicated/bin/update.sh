...
LINUX=rsync://quake2world.net/quake2world-dedicated-linux/${ARCH}/
...
sed -i "s:%QUAKE2WORLD_HOME%:${QUAKE2WORLD_HOME}:g" \
	"${QUAKE2WORLD_HOME}/Quake2World Dedicated.desktop" \
	"${QUAKE2WORLD_HOME}/Quake2World Dedicated Update.desktop"
