...
UPLOAD(){
	...
	ssh satgnu.net@satgnu.net ln -f /var/www/htdocs/vhosts/satgnu.net/files/quake2world_rev"$rev"zip  /var/www/htdocs/vhosts/satgnu.net/files/quake2world-win32-snapshot.zip
}
