...
struct PrimaryButtonInterface {
	...
	/**
	 * @fn void PrimaryButton::input(View *view, const char *name, ActionFunction action)
	 *
	 * @brief Creates and appends a new Input in the specified View.
	 *
	 * @param bind The button name (e.g. `Multiplayer`).
	 * @param action The ActionFunction.
	 ...
	 * @static
	 */
	void (*button)(View *view, const char *name, ActionFunction action, ident sender, ident data);
};
