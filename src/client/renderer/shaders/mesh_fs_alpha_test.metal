...
constant spvUnsafeArray<float, 8> _1890 = spvUnsafeArray<float, 8>({ 0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875, 1.0 });
...
fragment main0_out main0(main0_in in [[stage_in]], constant uniforms_block& _500 [[buffer(0)]], constant mesh_locals_block& _1437 [[buffer(1)]], constant material_block& material [[buffer(2)]], const device bsp_lights_block& _1400 [[buffer(3)]], const device dynamic_lights_block& _1430 [[buffer(4)]], const device voxel_light_data_block& _551 [[buffer(5)]], const device voxel_light_indices_block& _569 [[buffer(6)]], texture2d_array<float> texture_material [[texture(0)]], depth2d<float> texture_shadow_atlas_0 [[texture(1)]], depth2d<float> texture_shadow_atlas_1 [[texture(2)]], depth2d<float> texture_shadow_atlas_2 [[texture(3)]], depth2d<float> texture_shadow_atlas_3 [[texture(4)]], depth2d<float> texture_shadow_atlas_4 [[texture(5)]], depth2d<float> texture_shadow_atlas_5 [[texture(6)]], texture3d<float> texture_voxel_caustics [[texture(7)]], texture3d<float> texture_voxel_occlusion [[texture(8)]], texturecube<float> texture_sky [[texture(9)]], texture2d<float> texture_stage [[texture(10)]], texture2d<float> texture_stage_next [[texture(11)]], sampler texture_materialSmplr [[sampler(0)]], sampler texture_shadow_atlas_0Smplr [[sampler(1)]], sampler texture_shadow_atlas_1Smplr [[sampler(2)]], sampler texture_shadow_atlas_2Smplr [[sampler(3)]], sampler texture_shadow_atlas_3Smplr [[sampler(4)]], sampler texture_shadow_atlas_4Smplr [[sampler(5)]], sampler texture_shadow_atlas_5Smplr [[sampler(6)]], sampler texture_voxel_causticsSmplr [[sampler(7)]], sampler texture_voxel_occlusionSmplr [[sampler(8)]], sampler texture_skySmplr [[sampler(9)]], sampler texture_stageSmplr [[sampler(10)]], sampler texture_stage_nextSmplr [[sampler(11)]], float4 gl_FragCoord [[position]])
{
    ...
    if (material.flags == 0)
    {
        ...
        float4 _1685 = fragment0.diffuse_sample;
        float3 _1687 = _1685.xyz * (1.0 - tintmap.w);
        fragment0.diffuse_sample.x = _1687.x;
        fragment0.diffuse_sample.y = _1687.y;
        fragment0.diffuse_sample.z = _1687.z;
        float4 _1705 = fragment0.diffuse_sample;
        float3 _1707 = _1705.xyz + ((material.tint_colors[0] * tintmap.x).xyz * tintmap.w);
        fragment0.diffuse_sample.x = _1707.x;
        fragment0.diffuse_sample.y = _1707.y;
        fragment0.diffuse_sample.z = _1707.z;
        float4 _1724 = fragment0.diffuse_sample;
        float3 _1726 = _1724.xyz + ((material.tint_colors[1] * tintmap.y).xyz * tintmap.w);
        fragment0.diffuse_sample.x = _1726.x;
        fragment0.diffuse_sample.y = _1726.y;
        fragment0.diffuse_sample.z = _1726.z;
        float4 _1743 = fragment0.diffuse_sample;
        float3 _1745 = _1743.xyz + ((material.tint_colors[2] * tintmap.z).xyz * tintmap.w);
        fragment0.diffuse_sample.x = _1745.x;
        fragment0.diffuse_sample.y = _1745.y;
        fragment0.diffuse_sample.z = _1745.z;
        ...
        float4 _1781 = out.out_color;
        float3 _1783 = _1781.xyz * (fragment0.ambient + fragment0.diffuse);
        out.out_color.x = _1783.x;
        out.out_color.y = _1783.y;
        out.out_color.z = _1783.z;
        float4 _1792 = out.out_color;
        float3 _1794 = _1792.xyz + fragment0.specular;
        out.out_color.x = _1794.x;
        out.out_color.y = _1794.y;
        out.out_color.z = _1794.z;
    }
    else
    {
        ...
        if ((material.flags & 65536) == 65536)
        {
            ...
            fragment0 = param_6;
            float4 _1835 = out.out_color;
            float3 _1837 = _1835.xyz * mix(float3(1.0), fragment0.ambient + fragment0.diffuse, float3(material.lighting));
            out.out_color.x = _1837.x;
            out.out_color.y = _1837.y;
            out.out_color.z = _1837.z;
            float4 _1849 = out.out_color;
            float3 _1851 = _1849.xyz + (fragment0.specular * material.lighting);
            out.out_color.x = _1851.x;
            out.out_color.y = _1851.y;
            out.out_color.z = _1851.z;
        }
        if ((material.flags & 262144) == 262144)
        {
            float4 _1872 = out.out_color;
            float3 _1874 = _1872.xyz + (fragment0.diffuse_sample.xyz * material.emissive);
