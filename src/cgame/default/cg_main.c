...
static void Cg_Init(void) {
	...
	cg_autoswitch = cgi.Cvar("autoswitch", "1", CVAR_USER_INFO | CVAR_ARCHIVE,
				 "The weapon pickup autoswitch method. 0 disables, 1 autoswitches from Blaster only, 2 always switches.");
