 ...
 * @brief
 */
static void G_func_button_Die(g_edict_t *self, g_edict_t *attacker, uint32_t mod __attribute__((unused))) {
 ...
 * @brief
 */
static void G_func_door_Die(g_edict_t *self, g_edict_t *attacker, uint32_t mod __attribute__((unused))) {
	g_edict_t *ent;
