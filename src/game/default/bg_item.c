...
const g_item_def_t bg_item_defs[] = {
...

  {
    ...
    .type = ITEM_WEAPON,
    .tag = WEAPON_BLASTER,
    .effect_color = { { 0.482f, 0.119f, 0.057f, 1.f } },
    .flags = WF_PROJECTILE,
    .priority = 0.10,
...

  {
    ...
    .type = ITEM_WEAPON,
    .tag = WEAPON_SHOTGUN,
    .effect_color = { { 0.414f, 0.516f, 0.311f, 1.f } },
...

  {
    ...
    .effect_color = { { 0.473f, 0.426f, 0.314f, 1.f } },
...

  {
    ...
    .effect_color = { { 0.491f, 0.420f, 0.269f, 1.f } },
    .flags = WF_HITSCAN | WF_SHORT_RANGE | WF_MED_RANGE,
    .priority = 0.30,
...

  {
    ...
    .effect_color = { { 0.154f, 0.663f, 0.155f, 1.f } },
...

  {
    ...
    .effect_color = { { 0.585f, 0.506f, 0.230f, 1.f } },
...

  {
    ...
    .effect_color = { { 0.589f, 0.437f, 0.330f, 1.f } },
...

  {
    ...
    .effect_color = { { 0.006f, 0.518f, 0.532f, 1.f } },
...

  {
    ...
    .effect_color = { { 0.390f, 0.373f, 0.202f, 1.f } },
    .flags = WF_HITSCAN | WF_SHORT_RANGE,
    .priority = 0.50,
...

  {
    ...
    .type = ITEM_WEAPON,
    .tag = WEAPON_RAILGUN,
    .effect_color = { { 0.610f, 0.468f, 0.160f, 1.f } },
...

  {
    ...
    .type = ITEM_WEAPON,
    .tag = WEAPON_BFG10K,
    .effect_color = { { 0.256f, 0.442f, 0.059f, 1.f } },
...

  {
    ...
    .effect_color = { { 0.389f, 0.370f, 0.356f, 1.f } },
    .flags = WF_HITSCAN | WF_SHORT_RANGE,
    .priority = 0.15,
    .precaches = "weapons/shotgun/fire.wav"
  },

  {
    ...
    .effect_color = { { 0.578f, 0.550f, 0.510f, 1.f } },
    .flags = WF_HITSCAN | WF_SHORT_RANGE,
    .priority = 0.25,
    .precaches = "weapons/supershotgun/fire.wav"
  },

  {
    ...
    .effect_color = { { 0.463f, 0.444f, 0.393f, 1.f } },
...

  {
    ...
    .effect_color = { { 0.689f, 0.653f, 0.659f, 1.f } },
    .flags = WF_HITSCAN | WF_MED_RANGE,
    .priority = 0.40,
    .precaches = "weapons/machinegun/fire_1.wav"
  },

  {
    ...
    .effect_color = { { 0.425f, 0.232f, 0.121f, 1.f } },
...

  {
    ...
    .effect_color = { { 0.408f, 0.371f, 0.307f, 1.f } },
    .flags = WF_PROJECTILE | WF_EXPLOSIVE | WF_MED_RANGE | WF_LONG_RANGE,
    .priority = 0.60,
...

  {
    ...
    .effect_color = { { 0.836f, 0.822f, 0.745f, 1.f } },
    .flags = WF_HITSCAN | WF_SHORT_RANGE,
    .priority = 0.55,
    .precaches = "weapons/lightning/fire.wav weapons/lightning/fly.wav "
    "weapons/lightning/discharge.wav"
...

  {
    ...
    .type = ITEM_ARMOR,
    .tag = ARMOR_SHARD,
    .effect_color = { { 0.397f, 0.401f, 0.381f, 1.f } },
    .priority = 0.10,
    .precaches = ""
  },

  {
    ...
    .type = ITEM_ARMOR,
    .tag = ARMOR_JACKET,
    .effect_color = { { 0.322f, 0.428f, 0.243f, 1.f } },
    .priority = 0.50,
    .precaches = ""
  },
...

  {
    ...
    .type = ITEM_TECH,
    .tag = TECH_HASTE,
    .effect_color = { { 0.396f, 0.315f, 0.137f, 1.f } },
    .priority = 0.80,
    .precaches = ""
  },

  {
    ...
    .type = ITEM_TECH,
    .tag = TECH_REGEN,
    .effect_color = { { 0.429f, 0.431f, 0.441f, 1.f } },
    .priority = 0.80,
    .precaches = ""
  },

  {
    ...
    .type = ITEM_TECH,
    .tag = TECH_RESIST,
    .effect_color = { { 0.405f, 0.405f, 0.416f, 1.f } },
    .priority = 0.80,
    .precaches = ""
  },

  {
    ...
    .type = ITEM_TECH,
    .tag = TECH_STRENGTH,
    .effect_color = { { 0.385f, 0.263f, 0.268f, 1.f } },
    .priority = 0.80,
    .precaches = ""
  },

  {
    ...
    .type = ITEM_TECH,
    .tag = TECH_VAMPIRE,
    .effect_color = { { 0.385f, 0.370f, 0.376f, 1.f } },
    .priority = 0.80,
    .precaches = ""
  },
