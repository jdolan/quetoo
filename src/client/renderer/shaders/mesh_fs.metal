...
constant spvUnsafeArray<float, 8> _1978 = spvUnsafeArray<float, 8>({ 0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875, 1.0 });
...
fragment main0_out main0(main0_in in [[stage_in]], constant uniforms_block& _513 [[buffer(0)]], constant mesh_locals_block& _1586 [[buffer(1)]], constant material_block& material [[buffer(2)]], const device bsp_lights_block& _1549 [[buffer(3)]], const device dynamic_lights_block& _1579 [[buffer(4)]], const device voxel_light_data_block& _564 [[buffer(5)]], const device voxel_light_indices_block& _582 [[buffer(6)]], texture2d_array<float> texture_material [[texture(0)]], depth2d<float> texture_shadow_atlas_0 [[texture(1)]], depth2d<float> texture_shadow_atlas_1 [[texture(2)]], depth2d<float> texture_shadow_atlas_2 [[texture(3)]], depth2d<float> texture_shadow_atlas_3 [[texture(4)]], depth2d<float> texture_shadow_atlas_4 [[texture(5)]], depth2d<float> texture_shadow_atlas_5 [[texture(6)]], texture3d<float> texture_voxel_caustics [[texture(7)]], texture3d<float> texture_voxel_occlusion [[texture(8)]], texturecube<float> texture_sky [[texture(9)]], texture2d<float> texture_stage [[texture(10)]], texture2d<float> texture_stage_next [[texture(11)]], sampler texture_materialSmplr [[sampler(0)]], sampler texture_shadow_atlas_0Smplr [[sampler(1)]], sampler texture_shadow_atlas_1Smplr [[sampler(2)]], sampler texture_shadow_atlas_2Smplr [[sampler(3)]], sampler texture_shadow_atlas_3Smplr [[sampler(4)]], sampler texture_shadow_atlas_4Smplr [[sampler(5)]], sampler texture_shadow_atlas_5Smplr [[sampler(6)]], sampler texture_voxel_causticsSmplr [[sampler(7)]], sampler texture_voxel_occlusionSmplr [[sampler(8)]], sampler texture_skySmplr [[sampler(9)]], sampler texture_stageSmplr [[sampler(10)]], sampler texture_stage_nextSmplr [[sampler(11)]], float4 gl_FragCoord [[position]])
{
    ...
    if (material.flags == 0)
    {
        ...
        float4 _1773 = fragment0.diffuse_sample;
        float3 _1775 = _1773.xyz * (1.0 - tintmap.w);
        fragment0.diffuse_sample.x = _1775.x;
        fragment0.diffuse_sample.y = _1775.y;
        fragment0.diffuse_sample.z = _1775.z;
        float4 _1793 = fragment0.diffuse_sample;
        float3 _1795 = _1793.xyz + ((material.tint_colors[0] * tintmap.x).xyz * tintmap.w);
        fragment0.diffuse_sample.x = _1795.x;
        fragment0.diffuse_sample.y = _1795.y;
        fragment0.diffuse_sample.z = _1795.z;
        float4 _1812 = fragment0.diffuse_sample;
        float3 _1814 = _1812.xyz + ((material.tint_colors[1] * tintmap.y).xyz * tintmap.w);
        fragment0.diffuse_sample.x = _1814.x;
        fragment0.diffuse_sample.y = _1814.y;
        fragment0.diffuse_sample.z = _1814.z;
        float4 _1831 = fragment0.diffuse_sample;
        float3 _1833 = _1831.xyz + ((material.tint_colors[2] * tintmap.z).xyz * tintmap.w);
        fragment0.diffuse_sample.x = _1833.x;
        fragment0.diffuse_sample.y = _1833.y;
        fragment0.diffuse_sample.z = _1833.z;
        ...
        float4 _1869 = out.out_color;
        float3 _1871 = _1869.xyz * (fragment0.ambient + fragment0.diffuse);
        out.out_color.x = _1871.x;
        out.out_color.y = _1871.y;
        out.out_color.z = _1871.z;
        float4 _1880 = out.out_color;
        float3 _1882 = _1880.xyz + fragment0.specular;
        out.out_color.x = _1882.x;
        out.out_color.y = _1882.y;
        out.out_color.z = _1882.z;
    }
    else
    {
        ...
        if ((material.flags & 65536) == 65536)
        {
            ...
            fragment0 = param_6;
            float4 _1923 = out.out_color;
            float3 _1925 = _1923.xyz * mix(float3(1.0), fragment0.ambient + fragment0.diffuse, float3(material.lighting));
            out.out_color.x = _1925.x;
            out.out_color.y = _1925.y;
            out.out_color.z = _1925.z;
            float4 _1937 = out.out_color;
            float3 _1939 = _1937.xyz + (fragment0.specular * material.lighting);
        ...
        if ((material.flags & 262144) == 262144)
        {
            ...
            float3 _1962 = _1960.xyz + (fragment0.diffuse_sample.xyz * material.emissive);
