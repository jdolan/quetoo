...
int32_t Cm_BoxOnPlaneSide(const bounds_t bounds, const cm_bsp_plane_t *plane);
...
size_t Cm_BoxLeafnums(const bounds_t bounds, int32_t *list, size_t len, int32_t *top_node, int32_t head_node, const mat4_t *matrix);
