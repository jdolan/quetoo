...
#define CONTENTS_MASK_CURRENT			(CONTENTS_MASK_CURRENT_0 | CONTENTS_MASK_CURRENT_90 | CONTENTS_MASK_CURRENT_180 | CONTENTS_MASK_CURRENT_270 | CONTENTS_MASK_CURRENT_UP | CONTENTS_MASK_CURRENT_DOWN)
