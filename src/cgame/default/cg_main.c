...
static void Cg_Init(void) {
	...
	cg_draw_notifications = cgi.AddCvar("cg_draw_notifications", "1", CVAR_ARCHIVE, "Draw the notification feed on the HUD.");
	cg_draw_notifications_disable_print = cgi.AddCvar("cg_draw_notifications_disable_print", "1", CVAR_ARCHIVE,
													  "Disable notifications being printed to the console.");
	cg_draw_notifications_lines = cgi.AddCvar("cg_draw_notifications_lines", "6", CVAR_ARCHIVE,
											  "How many lines, at most, to display in the notification feed.");
	cg_draw_notifications_time = cgi.AddCvar("cg_draw_notifications_time", "1.0", CVAR_ARCHIVE,
