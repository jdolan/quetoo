...
typedef struct node_s {
	...
	qbsp_brush_t *volume; // one for each leaf/node
	...
	// leafs only
	qbsp_brush_t *brushes; // fragments of all brushes in this leaf
...
void WriteBrushMap(char *name, qbsp_brush_t *list);

// brushbsp.c
void WriteBrushList(char *name, qbsp_brush_t *brush, _Bool onlyvis);
...
void FreeBrush(qbsp_brush_t *brushes);
