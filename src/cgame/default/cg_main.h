...
extern cvar_t *cg_draw_notifications;
extern cvar_t *cg_draw_notifications_disable_print;
extern cvar_t *cg_draw_notifications_lines;
extern cvar_t *cg_draw_notifications_time;
