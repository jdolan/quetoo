...
#define BSP_LIGHT_SURFACE_SKY_RADIUS_SCALE 1.0
#define BSP_LIGHT_POINT_RADIUS_SCALE 2.0
#define BSP_LIGHT_COLOR_COMPONENT_MAX 0.6
...
static void R_ResolveBspLightParameters(void){
	...
	if((c = R_WorldspawnValue("sun_color"))){
		sscanf(c, "%f %f %f", &r_locals.sun_color[0],
