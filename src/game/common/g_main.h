...
extern cvar_t *g_death_cam_distance;
extern cvar_t *g_death_cam_height;
extern cvar_t *g_death_cam_rise;
extern cvar_t *g_death_cam_time;
extern cvar_t *g_death_cam_velocity;
