...
static void Cg_Init(void) {
  ...
  cg_spectator = cgi.AddCvar("spectator", "0", CVAR_ARCHIVE | CVAR_USER_INFO, "Controls connection spectator status. If 1, you'll be put into spectator mode automatically.");
