 ...
 */
static void Cg_BfgLaserThink(CGameSprite *sprite, float life, float delta) {

  const CGameBfgLaserData data = { .data = sprite->data };
 ...
 */
static void Cg_SplashEffect_Think(CGameSprite *s, float life, float delta) {
