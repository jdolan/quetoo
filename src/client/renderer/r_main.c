...
static void R_InitLocal(void) {
	...
	r_texture_quality = Cvar_Add("r_texture_quality", "1", CVAR_ARCHIVE | CVAR_R_MEDIA, "Controls the divisor for textures. Best values are between 1 and 16, inclusive.");
