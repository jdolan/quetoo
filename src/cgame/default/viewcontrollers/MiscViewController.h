...
typedef struct MiscViewController MiscViewController;
typedef struct MiscViewControllerInterface MiscViewControllerInterface;
...
/**
 * @brief The MiscViewController interface.
 */
struct MiscViewControllerInterface {
 ...
 * @brief The MiscViewController archetype.
 * @return The MiscViewController Class.
 * @memberof MiscViewController
 */
extern Class *_MiscViewController(void);
