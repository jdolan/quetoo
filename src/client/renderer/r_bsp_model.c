...
static void R_LoadBspFaces(r_bsp_model_t *bsp) {
	...
	bsp->num_faces = bsp->file->num_faces;
...
static void R_LoadBspLeafFaces(r_bsp_model_t *bsp) {
	...
	bsp->num_leaf_faces = bsp->file->num_leaf_faces;
