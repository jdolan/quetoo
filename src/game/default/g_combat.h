...
void G_Damage(g_edict_t *targ, g_edict_t *inflictor, g_edict_t *attacker, const vec3_t dir,
		const vec3_t point, const vec3_t normal, int16_t damage, int16_t knockback, int32_t dflags,
		int32_t mod);
