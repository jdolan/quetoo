...
rsync.exe -az --progress --exclude=rsync.exe --exclude=cygwin1.dll rsync://satgnu.net/quake2world-win32 .
rsync.exe --delete -az --progress rsync://satgnu.net/quake2world temp
