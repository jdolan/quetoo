...
**Read [`AGENTS.md`](AGENTS.md) first.** It is the shared instruction set for coding agents, and it
carries the naming conventions, the build rules, the constraints that live outside this repository,
and the ordering traps.
