/*
    ...
    OpenGL loader generated by glad 0.1.12a0 on 10/15/16 09:53:06.
    ...
    Commandline:
        --profile="compatibility" --api="gl=2.1" --generator="c" --spec="gl" --local-files --omit-khrplatform --extensions="GL_EXT_texture_filter_anisotropic,GL_SGIS_generate_mipmap"
    Online:
        http://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&loader=on&api=gl%3D2.1&extensions=GL_EXT_texture_filter_anisotropic&extensions=GL_SGIS_generate_mipmap
*/
