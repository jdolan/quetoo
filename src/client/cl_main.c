...
static void Cl_InitLocal(void) {
  ...
  cl_draw_counters = Cvar_Add("cl_draw_counters", "0", CVAR_ARCHIVE, "Draw the speed, fps and pps counters at the bottom-right");
  cl_draw_position = Cvar_Add("cl_draw_position", "0", CVAR_DEVELOPER, "Draw your current position to the screen");
  cl_draw_net_graph = Cvar_Add("cl_draw_net_graph", "0", CVAR_ARCHIVE, "Draw the net graph at the bottom-right");
