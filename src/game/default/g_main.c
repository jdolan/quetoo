...
void G_Init(void) {
	...
	g_force_demo = gi.Cvar("g_force_demo", "0", CVAR_SERVER_INFO | CVAR_LATCH, "Force all players to record a demo");
	g_force_screenshot = gi.Cvar("g_force_screenshot", "0", CVAR_SERVER_INFO | CVAR_LATCH, "Force all players to take a screenshot");
	...
	g_match = gi.Cvar("g_match", "0", CVAR_SERVER_INFO | CVAR_LATCH, "Enables match play requiring players to ready");
	...
	g_round_limit = gi.Cvar("g_round_limit", "30", CVAR_SERVER_INFO | CVAR_LATCH, "The number of rounds to run per level");
	g_rounds = gi.Cvar("g_rounds", "0", CVAR_SERVER_INFO | CVAR_LATCH, "Enables rounds-based play, where last player standing wins");
	...
	g_teams = gi.Cvar("g_teams", "0", CVAR_SERVER_INFO | CVAR_LATCH, "Enables teams-based play");
	g_time_limit = gi.Cvar("g_time_limit", "20.0", CVAR_SERVER_INFO | CVAR_LATCH, "The time limit per level in minutes");
