...
call ROBO "../src/cgame/common/ui/" "%quetoo_folder%/lib/ui/" *.css
call ROBO "../src/client/ui/" "%quetoo_folder%/lib/ui/" *.css
call ROBO "../src/cgame/common/ui/" "%quetoo_folder%/lib/ui/" *.json
call ROBO "../src/client/ui/" "%quetoo_folder%/lib/ui/" *.json
